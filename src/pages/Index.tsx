      ...
      <nav className="bg-[#2f3136] border-b border-[#202225] px-4 sm:px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Kisrod</h1>
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Переписка и общение нового поколения</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className={`${mobileSidebarOpen ? "block" : "hidden"} lg:block w-full lg:w-60 bg-[#2f3136] flex flex-col`}>
            <div className="p-4 border-b border-[#202225] flex items-center justify-between">
              <h2 className="text-white font-semibold text-base">Kisrod</h2>
              <Button
                variant="ghost"
            ...
            <div className="p-2 bg-[#292b2f] flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-white text-sm font-medium truncate">Кирилл</div>
                <div className="text-[#b9bbbe] text-xs truncate">#kisrod</div>
              </div>
          ...
          <div className="flex-1 flex flex-col">
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Общайся свободно — здесь все свои</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Kisrod</span>
                    <span className="text-[#72767d] text-xs hidden sm:inline">Бот · Сегодня в 9:00</span>
                  </div>
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать в Kisrod!</strong> Место, где переписка становится настоящим удовольствием.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      <h3 className="text-white font-semibold mb-2 text-sm sm:text-base">Что умеет Kisrod:</h3>
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        <li>💬 Мгновенная переписка с друзьями и группами</li>
                        <li>🔒 Приватные и зашифрованные чаты</li>
                        <li>😊 Реакции, стикеры и гифки</li>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Наконец-то удобный мессенджер! Всё быстро и без лишнего
                  </div>
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">Kisrod</div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base mb-3">
                    Kisrod — это огонь 🔥 Наконец-то можно нормально общаться!
                  </div>

                  {/* Фичи */}
                  <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-3 sm:p-4 w-full max-w-sm">
                    <h4 className="text-white font-semibold text-xs sm:text-sm mb-3">Почему Kisrod?</h4>
                    {[
                      {
                      ...
                      },
                      {
                        ...
                        desc: "Видишь, когда сообщение прочитано",
                      },
                      {
                        icon: <Clock className="w-4 h-4 sm:w-5 sm:h-5" />,
                        title: "История чатов",
                        desc: "Все переписки сохраняются навсегда",
                      },
                      {
                        icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                        title: "Безопасность",
                        desc: "Шифрование и защита данных",
                      },
                    ].map((feature, index) => (
                      <div
                        key={index}
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    <span className="text-white font-medium text-sm sm:text-base">Kisrod</span>
                    <span className="text-[#72767d] text-xs hidden sm:inline">Бот · Сегодня в 12:15</span>
                  </div>
                  <div className="bg-[#2f3136] border border-[#5865f2] rounded-lg p-4 sm:p-6 max-w-md">
                    <h3 className="text-white text-base sm:text-lg font-bold mb-2">Готов начать общаться?</h3>
                    <p className="text-[#b9bbbe] text-sm mb-4">
                      Присоединяйся к тысячам пользователей, которые уже общаются в Kisrod. Быстро, удобно и безопасно.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button className="bg-[#5865f2] hover:bg-[#4752c4] text-white px-6 py-2 rounded font-medium">
                        <Download className="w-4 h-4 mr-2" />
                        Начать бесплатно
                      </Button>
                      <Button variant="ghost" className="text-[#b9bbbe] hover:text-white hover:bg-[#40444b] px-6 py-2 rounded font-medium">
                        Узнать больше
                      </Button>
                    </div>
                  </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  { name: "Кирилл", status: "Слушает музыку 🎵", avatar: "К", color: "from-blue-500 to-purple-500" },
                  { name: "Дарья", status: "Только что зашла", avatar: "Д", color: "from-orange-500 to-red-500" },
                ].map((user, index) => (
